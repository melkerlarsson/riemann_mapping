...
\begin{proof}
    ...
    \begin{figure}
        \begin{center}
            \includegraphics[width=0.8\textwidth, trim=0 3cm 0 2.5cm, clip]{figures/normalfamily1.png}
        \end{center}
        \caption{Visualisering över delmängderna $K_n$ och $K_{n+1}$ av $\Omega$ samt punkterna $z_0$ och $z_1$.}\label{fig:normalfamily1}
    \end{figure}
