...
\begin{proof}
	...
	\end{equation}
	för något $\beta$ så kommer $\tilde{\Psi} \in \Sigma$. Låter vi funktionen $s$ vara kvadratfunktionen, det vill säga $s(w) = w^2$ så kommer det enligt \eqref{eq:g^2} och \eqref{eq:psi-tilde} gälla att
