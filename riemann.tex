...
\begin{proof}
	...
	Låt oss nu visa att $\zeta$ ligger i $\Sigma$ och att den därmed lägger $\Omega$ på $U$. Eftersom $\zeta$ har nollskild derivata i $z_0$ följer det att den inte är konstant. Vidare gäller följande resultat, vars bevis vi utelämnar: om vi har en följd av injektiva holomorfa funktioner som lokalt konvergerar likformigt mot en icke-konstant gränsfunktion, så är även gränsfunktionen injektiv. Detta följer som en konsekvens av \emph{Hurwitz sats}. Vi kan därför säga att $\zeta$ är injektiv. Det återstår nu endast att se att den lägger $\Omega$ på $U$. Per definition gäller det att $\Psi_k(\Omega) \subset U$. Antag att det för något $z$ skulle gälla att $\zeta(z) \notin \overline{U}$. Vi kan då inte finna något $z'$ så att
	\begin{equation*}
